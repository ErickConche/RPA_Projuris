...
from models.queues.useCases.iniciarElemento.main import IniciarElementoQueue
...
class QueueExecucao:
    ...
    def iniciarElementoExecQueue(self,id):
        return IniciarElementoQueue(con=self.con,id=id).execute()
