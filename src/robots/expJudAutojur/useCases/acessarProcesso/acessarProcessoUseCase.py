        ...
        try:
            ...
            while attemp < max_attemp:
                ...
                if site_html.select_one("#tabview-pasta\\:form-dados-cadastrais"):
                    processo_encontrado = site_html.select_one("#tabview-pasta\\:form-dados-cadastrais\\:ff-numero_processo_unificado\\:txt-numeroprocessounificado").text
                    return processo_encontrado.replace("-","").replace(".","")
                attemp += 1
                time.sleep(1)
