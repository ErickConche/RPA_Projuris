...
class AcessarAgendamentosUseCase:
    def __init__(
        self,
        view_state: str,
        headers: dict,
    ...
    def execute(self):
        try:
            ...
            while attemp < max_attemp:
                ...
                texto_validacao = site_html.select_one("#tabview-pasta\\:aba-tarefa\\:form-tarefas\\:tabela_data").text

                if texto_validacao != 'Nenhum registro encontrado':
                    return site_html, True
                attemp += 1
                time.sleep(1)
            return site_html, False
        except Exception as error:
            message = f"Erro ao acessar agendamentos"
