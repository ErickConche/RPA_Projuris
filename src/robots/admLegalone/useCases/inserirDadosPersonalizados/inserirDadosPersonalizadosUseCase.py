...
class InserirDadosPersonalizadosUseCase:
    ...
    def execute(self):
        try:
            ...
            time.sleep(5)
            self.page.locator(f'tr[data-val-id="{Deparas.depara_tipo_reclamacao(self.tiporeclamacao)}"]').click() ### Criar depara
            time.sleep(1)
            ...
            time.sleep(5)
            self.page.locator(f'tr[data-val-id="{Deparas.depara_tipo_processo(self.tipoprocesso)}"]').click() ### Criar depara
            time.sleep(1)
