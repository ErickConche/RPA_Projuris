...
from robots.judAutojur.useCases.listarEnvolvidos.__model__.ObjEnvolvidosModel import ObjEnvolvidosModel
...
class CriarPessoaUseCase:
    ...
    def execute(self)->ObjEnvolvidosModel:
        try:
            ...
            body = urlencode({
                "javax.faces.partial.ajax": "true",
                "javax.faces.source": "form-salvar-pessoa:j_idt640",
                "javax.faces.partial.execute": "form-tipo-pessoa form-salvar-pessoa:j_idt640",
                "form-salvar-pessoa:j_idt640": "form-salvar-pessoa:j_idt640",
                "form-tipo-pessoa": "form-tipo-pessoa",
                "javax.faces.ViewState": view_state,
                "form-tipo-pessoa:j_idt26:tipo": tipo_pessoa,
                "form-tipo-pessoa:ff-nome:nome": self.envolvido.nome,
