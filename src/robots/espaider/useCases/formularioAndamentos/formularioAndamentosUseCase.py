    ...
    def execute(self):
        try:
            ...
            *** Informações Andamentos ***
            ...
            time.sleep(2)
            select_option(page=self.page, name="Desdobramento", value=self.data_input.numero_do_processo)
            time.sleep(2)
            info_andamentos_iframe.query_selector('[name="Evento"]').type(self.data_input.andamento)
            time.sleep(2)
            select_option(page=self.page, name="Evento", value=self.data_input.andamento)
            time.sleep(2)
            ...
            time.sleep(2)
            info_andamentos_iframe.query_selector('[data-icon="save"]').click()
            time.sleep(2)
