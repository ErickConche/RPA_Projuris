import pandas
import numpy
from robots.admAutojur.useCases.cookies.__model__.dadosCookiesModel import DadosCookiesModel

from robots.admAutojur.useCases.cookies.query.queryCookies import QueryCookies
