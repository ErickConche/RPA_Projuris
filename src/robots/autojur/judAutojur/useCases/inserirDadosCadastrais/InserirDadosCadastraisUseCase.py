...
class InserirDadosCadastraisUseCase:
    ...
    def execute(self):
        try:
            ...
            time.sleep(5)
            self.page.locator("#form-dados-cadastrais\\:j_idt323\\:10\\:j_idt324\\:ff\\:ac-orgao-julgador_input").click()
            time.sleep(2)
            self.page.locator("#form-dados-cadastrais\\:j_idt323\\:10\\:j_idt324\\:ff\\:ac-orgao-julgador_input").type(self.data_input.orgao_julgador)
            time.sleep(2)
            self.page.locator(f'li[data-item-label="{unidecode(self.data_input.orgao_julgador.replace("-"," ").upper())}"]').click()
            time.sleep(2)

            self.page.locator("#form-dados-cadastrais\\:j_idt323\\:16\\:j_idt324\\:ff\\:ac-rito_input").click()
            time.sleep(2)
            self.page.locator("#form-dados-cadastrais\\:j_idt323\\:16\\:j_idt324\\:ff\\:ac-rito_input").type(self.data_input.rito)
            time.sleep(2)
            self.page.locator(f'li[data-item-label="{self.data_input.rito}"]').click()
            time.sleep(2)

            self.page.locator("#form-dados-cadastrais\\:j_idt323\\:20\\:j_idt324\\:ff\\:ac-sistema-tribunal_input").click()
            time.sleep(2)
            self.page.locator("#form-dados-cadastrais\\:j_idt323\\:20\\:j_idt324\\:ff\\:ac-sistema-tribunal_input").type(self.data_input.sistema_tribunal)
            time.sleep(2)
            self.page.locator(f'li[data-item-label="{self.data_input.sistema_tribunal}"]').click()
            time.sleep(2)

            self.page.locator("#form-dados-cadastrais\\:j_idt323\\:4\\:j_idt324\\:ff\\:txt-descricao-objetos").click()
            time.sleep(2)
            self.page.locator("#form-dados-cadastrais\\:j_idt323\\:4\\:j_idt324\\:ff\\:txt-descricao-objetos").type(self.data_input.descricao_objeto)
            time.sleep(2)

            self.page.locator("#form-dados-cadastrais\\:j_idt323\\:15\\:j_idt324\\:ff\\:ac-competencia_input").click()
            time.sleep(2)
            self.page.locator("#form-dados-cadastrais\\:j_idt323\\:15\\:j_idt324\\:ff\\:ac-competencia_input").type(self.data_input.competencia)
            time.sleep(2)
            self.page.locator(f'li[data-item-label="{self.data_input.competencia}"]').click()
            time.sleep(2)

            self.page.locator("#form-dados-cadastrais\\:j_idt323\\:9\\:j_idt324\\:ff\\:ac-portfolio_input").click()
            time.sleep(2)
            self.page.locator("#form-dados-cadastrais\\:j_idt323\\:9\\:j_idt324\\:ff\\:ac-portfolio_input").type(self.data_input.portfolio)
            time.sleep(2)
