...
class BuscarDadosCidadeUseCase:
    ...
    def execute(self)->dict:
        try:
            ...
            url = f"https://booking.nextlegalone.com.br/config/Cidades/LookupCidade?idUF={str(self.id_uf)}&term={str(self.cidade)}&pageSize=50&_=1702583024801"
            ...
            cont = 1
            while cont < pages:
                url = f"https://booking.nextlegalone.com.br/config/Cidades/LookupCidade?idUF={str(self.id_uf)}&term={str(self.cidade)}&pageSize=50&pageIndex={str(cont+1)}&_=1702583024801"
                response = requests.get(url=url,headers=headers)
